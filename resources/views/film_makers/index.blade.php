            ...
            <td>
                <div class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="{{ route('film_makers.show', $filmMaker->id) }}">View Details</a></li>
                        @if ($filmMaker->status == 2)
                        <li><button class="dropdown-item approved" data-id="{{ $filmMaker->id }}">Approved</button></li>
                        @endif

                        @if ($filmMaker->status == 3)
                        <li><button class="dropdown-item activate" data-id="{{ $filmMaker->id }}">Activate</button></li>
                        @else
                        <li><button id="modelopen" type="button" class="dropdown-item modelopen" data-bs-toggle="modal" data-bs-target="#deactivatereason" data-id="{{ $filmMaker->id }}">Deactivate</button></li>
                        @endif
