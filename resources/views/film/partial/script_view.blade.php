...
<div class="table-responsive">
    <table class="table table-striped table-list-view">
        ...
        <tr>
            ...
            <tr>
                <td><strong>Writer's Statement :</strong></td>
                <td>{{$film->writer_statement ?? '' }}</td>
            </tr>
<tr>
    <td><strong>Do you want to direct your script? :</strong></td>
    <td>{{ isset($film->is_direct_your_script) ? ($film->is_direct_your_script ? 'Yes' : 'No') : '' }}</td>
</tr> 
        </tbody>
    </table>
</div>
        ...
        <tr>
            ...
            @foreach ($documentsArray as $key=>$document)
                    ...
                    @elseif ($document['type'] == 9)
                        <tr>
                            <td><strong>Synopsis (6 - 10 pages)  :</strong></td>
                            <td><a target="_blank" href="{{'https://wavesbazaar.com/api/project/file/read/'.$document['url']}}">{{  $document['name']}}</a></td>
                        </tr>
                    @endif
