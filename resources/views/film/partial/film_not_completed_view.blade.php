...
<tr>
    ...
    <td>{{ $filmType }}</td>
            ...
            <tr>
                <td><strong> Do you have a rough cut of your film?:</strong></td>
                <td>{{ isset($film->has_rough_cut) ? ($film->has_rough_cut ? 'Yes' : 'No') : '' }}</td>
            </tr>
            <tr>
                <td><strong> Post-production work remaining on the film:</strong></td>
                <td>{{$film->post_production_work ?? ''}}</td>
            </tr>
            <tr>
                <td><strong>Will your film be complete by November 20, 2025? :</strong></td>
                <td>{{ isset($film->will_be_complete_by) ? ($film->will_be_complete_by ? 'Yes' : 'No') : '' }}</td>
            </tr>
            <tr>
                <td><strong> Duration of the Rough Cut (Mins) :</strong></td>
