...
<div class="table-responsive">
    <table class="table table-striped table-list-view">
        ...
        <tr>
            ...
            <tr>
                <td><strong>Shoot Locations/s :</strong></td>
            ...
            <tr>
                <td><strong>Distribution and Marketing Strategy :</strong></td>
            ...
            <tr>
                <td><strong>Producer's Note :</strong></td>
...
<tr>
            ...
            @php
    // Determine Screenplay Type
    $screenplayBasedOn = 'NA';
    if ($film->screenplay == "1") {
        $screenplayBasedOn = "Original";
    } elseif ($film->screenplay == "2") {
        $screenplayBasedOn = "Adapted";
    }

    // Get Screenplay Description (only if screenplay is "1")
    $screenplayDescription = ($film->screenplay == "1" && !empty($film->screenplay_description))
        ? $film->screenplay_description
        : 'NA';

    // Get Series Based On (only if screenplay is "2")
    $seriesBasedOn = ($film->screenplay == "2" && !empty($film->series_based_on))
...
<tr>
    ...
    <td>{{ $screenplayBasedOn }}</td>
</tr>

<tr>
    <td><strong>Screenplay Description :</strong></td>
    <td>{{ $screenplayDescription }}</td>
</tr>
